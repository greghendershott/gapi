...
@hyperlink["https://developers.google.com/google-apps/calendar/firstapp" "Documentation link"]
@table-of-contents{}
...
@section{Functions for the `colors' resource}
...
@section{Functions for the `calendars' resource}
...
@section{Functions for the `calendarList' resource}
...
@section{Functions for the `freebusy' resource}
...
@section{Functions for the `settings' resource}
