...
@title{Google Web Fonts Developer API v1}
The Google Web Fonts Developer API.
@hyperlink["http://code.google.com/apis/webfonts/docs/developer_api.html" "Documentation link"]
@table-of-contents{}
...
@section{Functions for the `webfonts' resource}
@defproc[(webfonts.webfonts.list
...
@racket[sort]: Enables sorting of the list
